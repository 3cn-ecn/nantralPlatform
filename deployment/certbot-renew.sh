...
# Renew certificates
certbot certonly --force-renew --webroot --webroot-path ./certbot/www/ -d nantral-platform.fr -d wiki.nantral-platform.fr -d webmail.nantral-platform.fr -d dev.nantral-platform.fr -d www.nantral-platform.fr
