  ...
  const { data } = await axios
    .put<EditAccountOptionsDTO>(
      '/api/account/edit/',
      {
        ...
        // make sure to use dot notation instead of nested object here
        'student.description': formData.description,
        'student.picture': formData.picture,
        'student.path': formData.path,
        'student.faculty': formData.faculty,
        'student.promo': formData.promo,
        student: {
