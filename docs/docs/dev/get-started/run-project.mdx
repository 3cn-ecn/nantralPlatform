...
You can also use the following command from the root of the project to run everything
at once.
...
:::info
The docker and normal version do not use the same database. You will need to reo the initial
setup if you change your method.
:::
