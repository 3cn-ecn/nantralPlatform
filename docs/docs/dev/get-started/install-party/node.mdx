...
- Download **Node.js LTS** from [the official website](https://nodejs.org/en/).
  ...
  (also called the "LTS" version). Currently, it is the 26.10.0 version.
  You can check which version we are using with our [`.nvmrc`](https://github.com/3cn-ecn/nantralPlatform/blob/master/frontend/.nvmrc) file.
