...
| -------------------------------------------- | --------------------------------------- | ---------------------- | --------------------------------- |
| _Command to start each website_              | _`pipenv run start` or `npm run start`_ | _`docker compose up`_  | _`docker compose up`_             |
...
| Webmail admin interface                      | -                                       | -                      | https://mail.nantral-platform.fr  |
