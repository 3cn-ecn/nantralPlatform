    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place_required', models.BooleanField(default=False, help_text='Le lieu est disponible seulement si une carte est liée.')),
                ...
                ('is_year_group', models.BooleanField(default=False, help_text="Si vrai, les membres n'ont pas de dates.", verbose_name="Les groupes n'existent que sur une année scolaire.")),
                ('group_by_field', models.CharField(blank=True, max_length=30, verbose_name='Grouper en catégories selon le champ')),
                ('group_by_label', models.CharField(blank=True, help_text='Utiliser la syntaxe Python pour formater le texte avec le champ (cf https://docs.python.org/3/library/stdtypes.html#str.format)', max_length=100, verbose_name='Label des catégories')),
            ],
            options={
