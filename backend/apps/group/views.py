...
class ListGroupTypeView(ListView):
    ...
    def get_context_data(self, **kwargs) -> dict[str, any]:
        ...
        context["ariane"] = [{"target": "#", "label": _("Groups")}]
        return context
...
class ListGroupChildrenView(ListView):
    ...
    def get_context_data(self, **kwargs) -> dict[str, any]:
        ...
        context["ariane"] = [
            ...
            {"target": parent.get_absolute_url(), "label": parent.name},
            {"target": "#", "label": parent.children_label},
        ]
        return context
...
class CreateGroupView(UserPassesTestMixin, CreateView):
    ...
    def test_func(self) -> bool:
        ...
        return (
            ...
            or self.parent
            and self.parent.is_admin(self.request.user)
        )
