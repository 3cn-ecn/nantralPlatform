...
# alcool (pas compté individuellement mais avec la famille seulement)
coeffs += [0]
...
# EI2, présentation des familles
out_str_1 = '<p><a href="/html/ei1.html">Voir la liste des etudiants EI1</a></p><h1>Liste des EI1 par famille</h1>'
out_str_2 = out_str_1
