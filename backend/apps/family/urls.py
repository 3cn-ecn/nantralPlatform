...
from .views import (
    ...
    JoinFamilyView,
    UpdateFamilyView,
    QuestionnaryPageView,
    ItiiQuestionFamilyView)
...
urlpatterns = [
    ...
    path('liste-famille/join/', ListFamilyJoinView.as_view(),
         name='family-list-join'),
    ...
    path('famille/<int:pk>/question-itii/',
         ItiiQuestionFamilyView.as_view(), name='itii-question'),
    path('questionnaire/<int:id>/',
         QuestionnaryPageView.as_view(), name='questionnary'),
]
