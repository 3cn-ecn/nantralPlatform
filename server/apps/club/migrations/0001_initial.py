    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admins', models.ManyToManyField(blank=True, related_name='bdx_admins',
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('description', models.TextField(
                            blank=True, verbose_name='Description du groupe')),
                        ('logo', models.ImageField(blank=True, null=True, upload_to=apps.utils.upload.PathAndRename(
                            'groups/logo/group'), verbose_name='Logo du groupe')),
                        ('slug', models.SlugField(
                            blank=True, max_length=40, unique=True)),
                        ('modified_date', models.DateTimeField(auto_now=True)),
                        ('admins', models.ManyToManyField(blank=True, related_name='club_admins',
                                                          to='student.Student', verbose_name='Admins du groupe')),
                        ('bdx_type', models.ForeignKey(blank=True, null=True,
                                                       on_delete=django.db.models.deletion.SET_NULL, to='club.bdx', verbose_name='Type de club BDX')),
                    ],
                    options={
                        'abstract': False,
                    },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(blank=True,
                 null=True, verbose_name='Année du poste')),
                ('club', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='club.bdx')),
                ('student', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='student.student')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='members',
            field=models.ManyToManyField(
                through='club.NamedMembershipBDX', to='student.Student'),
        ),
        migrations.AddField(
            model_name='bdx',
            name='social',
