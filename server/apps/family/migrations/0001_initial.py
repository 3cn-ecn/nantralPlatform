# Generated by Django 3.2.4 on 2021-08-09 22:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('F', 'Féminin'), ('M', 'Masculin'), ('A', 'Autre')], max_length=1, null=True, verbose_name='Genre')),
                ('foreign_student', models.BooleanField(default=False, verbose_name='Êtes-vous un étudiant étranger ?')),
                ('itii', models.BooleanField(default=False, verbose_name='Êtes-vous un étudiant ITII ?')),
                ('remixage', models.BooleanField(default=False, verbose_name='Membre remixé')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to='family.family')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equivalent', models.OneToOneField(help_text='Question équivalente dans le questionnaire des membres', on_delete=django.db.models.deletion.CASCADE, to='family.questionmember', verbose_name='Question équivalente')),
            ],
            options={
